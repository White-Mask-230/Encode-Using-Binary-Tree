...
def create_dictionary_of_keys(text: List[str], dict_file_path="dictionary.json", inverted_file_path="inverted_dictionary.json") -> Tuple[str, str]:
    """
        # Functions
            Creates encoding and decoding dictionaries from the given text and saves them to files. The encoding dictionary maps symbols to unique numeric codes, and the decoding dictionary is the inverse.

        Args:
            * text (List[str]): A list of strings representing the text to encode.
            * dict_file_path (str): Name of the file where it will save the dictionary of keys; Default: dictionary.json
            * inverted_file_path (str): Name of the file where it will save the invert dictionary of keys; Default: dictionary.json

        Returns:
            * Tuple[str, str]: Tuple containing paths to the encoding dictionary file and the decoding (inverted) dictionary file.
    """
...
def encode(text: List[str], dict_path: str) -> str:
    """
        # Functions
            Encodes a list of strings using a dictionary stored in a file.
...
def decode(encoded_path: str, inverted_dict_path: str, output_path="decode.txt") -> None:
    """
        # Function
        ...
        # Args
            ...
            * output_path (str): Path to the output file to save decoded text; Default: dictionary.json
